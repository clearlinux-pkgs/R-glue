...
Version  : 1.3.2
Release  : 33
URL      : https://cran.r-project.org/src/contrib/glue_1.3.2.tar.gz
Source0  : https://cran.r-project.org/src/contrib/glue_1.3.2.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1584062321
