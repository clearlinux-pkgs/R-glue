...
Version  : 1.6.2
Release  : 64
URL      : https://cran.r-project.org/src/contrib/glue_1.6.2.tar.gz
Source0  : https://cran.r-project.org/src/contrib/glue_1.6.2.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1645721153
